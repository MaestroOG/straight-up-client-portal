...
//     useEffect(() => {
//         if (state?.success && state?.note) {
//             onNewNote(state.note);        // ← push the DB note into parent state
//             setValue("");                  // ← clear editor value
//             setEditorKey(k => k + 1);      // ← force Jodit to reset visually
//         }
//     }, [state, onNewNote]);
...
//             <Label className='text-heading' htmlFor="note">Add a Comment</Label>
//             <JoditEditor
//                 key={editorKey}               // ← forces editor to remount on reset
//                 ref={contentRef}
//                 tabIndex={1}
